...
const cfg = {
  ...
  version:
    process.env.HN_VERSION ||
    (String(process.env.HN_PROTOCOL || "") === "bedrock" ? "1.26.44" : "1.21.4"),
  protoNum: Number(process.env.HN_GAME_PROTOCOL || (String(process.env.HN_PROTOCOL || "") === "bedrock" ? 2168 : 769)),
...
function statusJson() {
  return {
    version: { name: `HoptoNode ${cfg.egg} ${cfg.version}`, protocol: cfg.protoNum || 769 },
    players: {
      max: cfg.maxPlayers,
